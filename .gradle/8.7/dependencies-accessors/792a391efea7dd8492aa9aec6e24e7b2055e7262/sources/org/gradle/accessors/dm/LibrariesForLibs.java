...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComGoogleFirebaseFirebaseLibraryAccessors extends SubDependencyFactory {
        private final ComGoogleFirebaseFirebaseAppcheckLibraryAccessors laccForComGoogleFirebaseFirebaseAppcheckLibraryAccessors = new ComGoogleFirebaseFirebaseAppcheckLibraryAccessors(owner);

        public ComGoogleFirebaseFirebaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.google.firebase.firebase.appcheck</b>
         */
        public ComGoogleFirebaseFirebaseAppcheckLibraryAccessors getAppcheck() {
            return laccForComGoogleFirebaseFirebaseAppcheckLibraryAccessors;
        }

    }

    public static class ComGoogleFirebaseFirebaseAppcheckLibraryAccessors extends SubDependencyFactory {

        public ComGoogleFirebaseFirebaseAppcheckLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getDebug() {
            return create("com.google.firebase.firebase.appcheck.debug");
        }
    ...
    public static class GoogleFirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        private final GoogleFirebaseStorageLibraryAccessors laccForGoogleFirebaseStorageLibraryAccessors = new GoogleFirebaseStorageLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>google.firebase.storage</b>
         */
        public GoogleFirebaseStorageLibraryAccessors getStorage() {
            return laccForGoogleFirebaseStorageLibraryAccessors;
        }
    ...
    public static class GoogleFirebaseAppcheckLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getDebug() {
            return create("google.firebase.appcheck.debug");
        }
    ...
    public static class GoogleFirebaseStorageLibraryAccessors extends SubDependencyFactory {

        public GoogleFirebaseStorageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("google.firebase.storage.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistPermissions</b> with value <b>0.30.0</b>
         * <p>
